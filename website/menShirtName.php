...
$sql = 'SELECT id, type, category, size, name FROM menShirt WHERE name="' . $_GET["name"] . '"';
...
<html>
  <div class="content">
    <head>
      <title>CLOBUNDANCE - MENS - SHIRTS</title>
...
';
        ...
        while($row = $result->fetch_assoc()) {
            echo '<a href="menShirtItem.php?id=' . $row["id"] . '">' . $row["size"] . "</a><br>\r\n";
        }
